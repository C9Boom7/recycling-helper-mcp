...
- Answer Quality 트랙: seed 116개, MCP answer cases 179개, Backlog는 `covered 109 / wont_fix 1 / todo 0`이다. 최근 source/region 보강 축과 `needs_source` 7개 보수 안내, `medicine`/폐의약품 포장재 분리, `spray_can` 찌그러짐 조건, 2026-07-05 source reflection smoke, Open Decision guard, 마포구 수수료 answer smoke까지 통과했다.
