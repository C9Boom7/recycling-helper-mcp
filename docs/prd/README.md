...
| 6 | R0~R4 완료, R5 남음 | claude/phase6-r2-r4 | 조례 10곳 1,146행 적재 — 수수료 보유 지역 8 → 18곳(비광역 전부), 행 849 → 1,995. R2 골든셋 69행 금액 불일치 0건, 파서 결함 둘을 고쳐 행 파싱 10/10. validate 규칙 3종·회귀 3건 추가. R5(링크·시행일자 재확인)는 8/22~23 |
