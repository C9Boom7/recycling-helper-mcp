...
| 질의 세트 | before not_found | after not_found |
| --- | --- | --- |
| 질문 백로그 111개 | 4건 (3.6%) | 1건 (0.9%) |
...
- 신규 품목 143개 (`review.status="standard_import"`), 평가 케이스 143개, MCP answer case 75개(지역 확인 필수 품목 전수) 추가.
