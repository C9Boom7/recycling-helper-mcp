...
- MCP 답변 품질 케이스: `src/data/mcp-answer-cases.json` (433개)
...
- 대형폐기물 수수료: `src/data/bulky-waste-fees.json` (18개 지역 2,025행 — 2026-08-16에 들어온 서울 8개 구는 아직 없다. 조례 ETL로 뒤따라 채운다)
